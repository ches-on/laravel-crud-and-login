  ...
  <div class="card">
    <div class="card-body login-card-body">
      <?php if(session('error')): ?>
          <div class="text-danger text-center"><?php echo e(session('error')); ?></div>
      <?php endif; ?>
      <?php if(session('success')): ?>
          <div class="text-success text-center"><?php echo e(session('success')); ?></div>
      <?php endif; ?>
...
<!-- AdminLTE App -->
<script src="<?php echo e(asset('admin-asset/dist/js/adminlte.min.js')); ?>"></script>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\blogger\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>